...
class Player:
    ...
    def play(self, card_index):
        ...
        """
        "*** YOUR CODE HERE ***"
        selected = self.hand.pop(card_index)
        return selected
...
class ProfessorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        "*** YOUR CODE HERE ***"
        oppo_atk = other_card.attack
        oppo_def = other_card.defense
        ...
        for i in range(orig_opponent_deck_length):
            if copy_oppo_deck[i].attack == other_card.attack or copy_oppo_deck[i].defense == other_card.defense:
                index_to_del.append(i)
        opponent.deck.cards = [copy_oppo_deck[i] for i in range(orig_opponent_deck_length) if i not in index_to_del]
