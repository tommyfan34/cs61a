...
class HungryAnt(Ant):
    ...
    def action(self, gamestate):
        ...
        if self.digesting:
            ...
            eaten = HungryAnt.eat_bee(self, rANTdom_else_none(self.place.bees))
            if eaten == True:
...
class ContainerAnt(Ant):
    ...
    def can_contain(self, other):
        ...
        if self.contained_ant != None:
            return False
        if isinstance(other, ContainerAnt) is False or other.contained_ant == None:
            return True
        else:
            return False
        # END Problem Optional 2
    ...
    def action(self, gamestate):
        ...
        if self.contained_ant is not None:   
            # print("DEBUG: " + self.contained_ant.name)
